        ...
        <div>
            {
                ...
                show && !showPaymentComponent ?
                    ...
                    <>
                        <div>
                            <div className="d-flex justify-content-center align-items-center br mb-5">
                                <div className="style-1">
                                    <div>
                                        <img className='me-5' src="https://images.unsplash.com/photo-1550507992-eb63ffee0847?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTZ8fHNhbmR3aWNofGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=500&q=60" alt="burger-1"></img>
                                    </div>
                                    <p className='text-center text-warning display'>Sandwich-1</p>
                                    <div>
                                        <h2 className='text-warning test display-6'>Price : $25</h2>
                                        <button onClick={() => showOrderForm()} className='btn btn-warning'>Buy Now</button>
                                    </div>
                                </div>
                                <div className="style-1">
                                    <div>
                                        <img className='me-5' src="https://images.unsplash.com/photo-1528735602780-2552fd46c7af?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mnx8c2FuZHdpY2h8ZW58MHx8MHx8&auto=format&fit=crop&w=500&q=60" alt="burger-2"></img>
                                    </div>
                                    <p className='text-center text-warning display'>Sandwich-2</p>
                                    <div>
                                        <h2 className='text-warning test display-6'>Price : $25</h2>
                                        <button onClick={() => showOrderForm()} className='btn btn-warning'>Buy Now</button>
                                    </div>
                                ...
                                <div className="style-1">
                                    <div>
                                        <img className='me-5' src="https://images.unsplash.com/photo-1608330557791-8dff6a434bbf?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8NDJ8fHNhbmR3aWNofGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=500&q=60" alt="burger-3"></img>
                                    </div>
                                    <p className='text-center text-warning display'>Sandwich-3</p>
                                    <div>
                                        <h2 className='text-warning test display-6'>Price : $25</h2>
                                        <button onClick={() => showOrderForm()} className='btn btn-warning'>Buy Now</button>
                                    </div>
                            ...
                            <div className="d-flex justify-content-center br mb-5">
                                <div className="style-1">
                                    <div>
                                        <img className='me-5' src="https://images.unsplash.com/photo-1576194555759-22b1e99820f1?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8NjJ8fHNhbmR3aWNofGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=500&q=60" alt="burger-4"></img>
                                    </div>
                                    <p className='text-center text-warning display'>Sandwich-4</p>
                                    <div>
                                        <h2 className='text-warning test display-6'>Price : $25</h2>
                                        <button onClick={() => showOrderForm()} className='btn btn-warning'>Buy Now</button>
                                    </div>
                                ...
                                <div className="style-1">
                                    <div>
                                        <img className='me-5' src="https://images.unsplash.com/photo-1626078302223-41c01f19f8c8?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8ODJ8fHNhbmR3aWNofGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=500&q=60" alt="burger-5"></img>
                                    </div>
                                    <p className='text-center text-warning display'>Sandwich-5</p>
                                    <div>
                                        <h2 className='text-warning test display-6'>Price : $25</h2>
                                        <button onClick={() => showOrderForm()} className='btn btn-warning'>Buy Now</button>
                                    </div>
                                ...
                                <div className="style-1">
                                    <div>
                                        <img className='me-5' src="https://images.unsplash.com/photo-1534422990240-a3a252bcf0f7?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MjMwfHxzYW5kd2ljaHxlbnwwfHwwfHw%3D&auto=format&fit=crop&w=500&q=60" alt="burger-6"></img>
                                    </div>
                                    <p className='text-center text-warning display'>Sandwich-6</p>
                                    <div>
                                        <h2 className='text-warning test display-6'>Price : $25</h2>
                                        <button onClick={() => showOrderForm()} className='btn btn-warning'>Buy Now</button>
                                    </div>
