                            ...
                            <div>
                                <div className="d-flex justify-content-center align-items-center br mb-5">
                                    <div className="style-1">
                                        <div>
                                            <img className='me-5' src="https://images.unsplash.com/photo-1571091718767-18b5b1457add?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8OXx8YnVyZ2VyfGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=500&q=60" alt="burger-1"></img>
                                        </div>
                                    ...
                                    <div className="style-1">
                                        <div>
                                            <img className='me-5' src="https://images.unsplash.com/photo-1551782450-17144efb9c50?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTJ8fGJ1cmdlcnxlbnwwfHwwfHw%3D&auto=format&fit=crop&w=500&q=60" alt="burger-2"></img>
                                        </div>
                                        <p className='text-center text-warning display'>The Italian Pizza</p>
                                        <div>
                                            <h4 className='text-warning test'>Price : 25</h4>
                                            <button onClick={() => setShow(true)} className='btn btn-warning'>Buy Now</button>
                                        </div>
                                    </div>
                                    <div className="style-1">
                                        <div>
                                            <img className='me-5' src="https://images.unsplash.com/photo-1499028344343-cd173ffc68a9?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTEwfHxidXJnZXJ8ZW58MHx8MHx8&auto=format&fit=crop&w=500&q=60" alt="burger-3"></img>
                                        </div>
                                ...
                                <div className="d-flex justify-content-center br mb-5">
                                    <div className="style-1">
                                        <div>
                                            <img className='me-5' src="https://images.unsplash.com/photo-1610614819513-58e34989848b?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTE4fHxidXJnZXJ8ZW58MHx8MHx8&auto=format&fit=crop&w=500&q=60" alt="burger-4"></img>
                                        </div>
                                    ...
                                    <div className="style-1">
                                        <div>
                                            <img className='me-5' src="https://images.unsplash.com/photo-1562514003-4ad85ecfc1a0?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTQzfHxidXJnZXJ8ZW58MHx8MHx8&auto=format&fit=crop&w=500&q=60" alt="burger-5"></img>
                                        </div>
                                    ...
                                    <div className="style-1">
                                        <div>
                                            <img className='me-5' src="https://images.unsplash.com/photo-1596059489932-64416a45d2e0?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MzYxfHxidXJnZXJ8ZW58MHx8MHx8&auto=format&fit=crop&w=500&q=60" alt="burger-6"></img>
                                        </div>
